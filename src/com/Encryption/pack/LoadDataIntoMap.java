...
public class LoadDataIntoMap {
	
	
	
	@SuppressWarnings("unused")
	public HashMap<Character, Float> UpdateMap(HashMap<Character, Float> PreMap) {
...
//		System.out.println("-------------------------------------------");
	...
	//adding the predefined frequencies for pairs 
		@SuppressWarnings("unused")
		public HashMap<String, Float> UpdateMapR(HashMap<String, Float> PreBioMoni){
